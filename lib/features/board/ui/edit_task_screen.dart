...
class _EditTaskScreenState extends ConsumerState<EditTaskScreen> with SingleTickerProviderStateMixin{
                ...
                children: [
                  Expanded(
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        projectsTab(assetName: AppAssets.taskTab, title: "TASK"),
                        projectsTab(assetName: AppAssets.commentsTab, title: "Comments"),
                      ],
  ...
  Widget projectsTab({required String assetName, required String title}){
    return Tab(
      child: Row(
